...
sudo -- sh -c "echo RewriteRule ^\(.*\)$ /~$argument3/$argument1/$escapestring [L] >> ~/Sites/.htaccess"
...
sudo -- sh -c "echo     RewriteBase /**USERNAME**/**SITENAME**/ >> ~/Sites/$argument1/.htaccess"
...
sudo -- sh -c "cat .htaccess.tmp >> .htaccess"
rm ~/Sites/$argument1/.htaccess.tmp
...
sudo -- sh -c "echo         DocumentRoot /Users/$escapestring/Sites/$argument1 >> /private/etc/apache2/extra/httpd-vhosts.conf"
sudo -- sh -c "echo         \<Directory /Users/$escapestring/Sites/$argument1\> >> /private/etc/apache2/extra/httpd-vhosts.conf"
